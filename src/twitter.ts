...
const getAllFriendList = async (_user_id: string, _screen_name: string) => {
  return new Promise(async (resolve, reject) => {
    try {
      let _next_cursor: number = -1;
      let arr_users = [];
...
const getAllFollowerList = async (_user_id: string, _screen_name: string) => {
  return new Promise(async (resolve, reject) => {
    try {
      let _next_cursor: number = -1;
      let arr_users = [];
...
const getUserDetail = async (user_id: string, screen_name: string) => {
  return new Promise((resolve, reject) => {
    axios
      .request({
        method: "get",
...
const look_up_user = async (screen_name: string) => {
  return new Promise((resolve, reject) => {
    axios
      .request({
        method: "get",
...
const getLoginSession = async (username: string, password: string) => {
  return new Promise(async (resolve, reject) => {
